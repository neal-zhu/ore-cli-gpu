...
use crate::{
    ...
    utils::{get_clock_account, get_proof, get_treasury,get_gpu_nonce_worker_path},
    Miner,
};
...
impl Miner {
    pub async fn mine(&self, threads: u64) {
        ...
        loop {
            ...
            let (next_hash, nonce) =self.mine_hashes(get_gpu_nonce_worker_path(), 0, &treasury.difficulty.into(), &proof.hash.into()).await;
